...
<?php
  session_start();
  echo $_SESSION['admin_name'] .$_SESSION['admin_id'] ;
?>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link fs-5" href="#">Dụng cụ tập luyện</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link fs-5" href="#">Whey </a>
          </li>
        </ul>
  ...
  <a href="#" ><button class="btn btn-success ">Quản lý sản phẩm</button></a>
  <a href="#" ><button class="btn btn-success ">Quản lý đơn hàng</button></a>
  <a href="#" ><button class="btn btn-success ">Quản lý tài khoản</button></a> 
</body>
