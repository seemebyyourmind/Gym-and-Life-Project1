          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              ...
              <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Đăng Nhập</p>
                ...
                <form class="mx-1 mx-md-4" class="form" action="logincheck.php" method="POST">
                  
                  
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                    <label class="form-label" for="form3Example3c">Tên đăng nhập(số điện thoại) </label>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" class="btn btn-primary btn-lg btn-block" name="login" value="đăng nhập" >Đăng nhập</button>
